...
private:
	...
	ConnectServer m_conn;				// 服务端链接
	CRect m_rcTitle;					// 标题栏 24像素
public:
	CComboBox m_comboxDate;
	CPlaceholderEdit m_editCode;
	CButton m_Query;
	CButton m_btnCustomSetting;
public:
